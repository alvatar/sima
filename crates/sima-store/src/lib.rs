//! Durability layer: content-addressed objects, the task index, per-search
...
//! maintenance operation [`Store::pack`], and deleting what no finalized search
