...
fn merged(outcome: Result<MigrateOutcome>, teardown: Result<()>) -> Result<MigrateOutcome> {
...
impl FarRun<'_> {
    ...
    fn journaling<T>(&self, body: impl FnOnce(&Emitter) -> Result<T>) -> Result<T> {
