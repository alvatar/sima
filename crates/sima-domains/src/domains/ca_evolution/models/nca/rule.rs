//! [`Nca`]: the neural cellular automaton, bound to the generic CA machinery
//! through [`CaModel`].

use super::gen_config::NcaGenConfig;
use super::genome::NcaGenome;
use super::ignition::NcaIgnition;
...
mod tests {
    ...
    mod executor {
        ...
        use super::*;
        use crate::domains::ca_evolution::continuation::{
            decode_continuation, encode_continuation,
        };
        use crate::domains::ca_evolution::executor::CaExecutor;
        use crate::domains::ca_evolution::params::encode_params;
