...
//! [`CudaEngine`](crate::cellular::CudaEngine).
//!
//! Both files are transcriptions of their WGSL counterparts one level up:
//! [`step`] mirrors [`cellular::step`](crate::cellular::step) and [`reduce`]
//! mirrors [`cellular::reduce`](crate::cellular::reduce). Reading a pair side
...
//! [`cellular::reduce`](crate::cellular::reduce), so the two reductions cannot
